...
console.log(basedatos[0]);
    ...
    <>
        ...
        <section className="container my-5">
            <div className="row">
                <div className="col-12 text-center">
                    <img src="../../src/assets/corte1.jpg" alt="img" className="w-50" />
                    <hr />
                    ...
                    basedatos.map(function(barbero){
                        return(
                            <div className="col my-3">
                                <div className="card text-bg-dark h-100 p-3">
                                    <p className="card-text fw-bold">{barbero.nombre}</p>
                                    <p className="card-text">  Especialidad: {barbero.especialidad}</p>
                                    <p className="card-text">  Experiencia: {barbero.experiencia}</p>
                                    <p className="card-text">  Correo: {barbero.correo}</p>
                                    <p className="card-text">  Contacto: {barbero.contacto} </p>
